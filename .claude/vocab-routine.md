...
| **Above-level words** | Words clearly beyond A1 (B1/B2 medical terms, A2 structures) go to **catIdx 15, "Lektion 15: A2 — Über A1 hinaus"**, not into an A1 Lektion and not dropped. Established 2026-09-05: the user wants them kept and learnable, just quarantined so they don't crowd out exam-relevant A1 vocabulary. Flag which words you routed there in the preview so the user can pull any back. |
| **Metalanguage** | Grammar terminology used to *talk about* German (der Nominativ, das Subjekt, maskulin, trennbares Verb) is still dropped entirely — it is reference material, not flashcard material. This is a different rule from "above-level": do not route metalanguage to Lektion 15. |
